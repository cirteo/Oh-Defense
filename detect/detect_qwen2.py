...
def defense_pipeline(args):
    ...
    model_name_without_ext = os.path.splitext(os.path.basename(model_name))[0]
    ...
    model, processor = get_qwen2_model(model_name, device=device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--threshold", type=float, default=1.22,
